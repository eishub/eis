...
After that, you will find three different jar-files in the \texttt{target/}-folder:
\begin{itemize}
...
It is required to add at least \texttt{eis-0.3.jar} to the class-path of your project.
You can either do this in the traditional way, that is copying and linking by hand. Alternatively, if your project already supports  
...
This can be changed during runtime by setting the static variable \texttt{toProlog} of the class
