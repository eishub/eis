...
public class Main {
	...
	public static void main(String[] args) {
		...
		// moving to (2,3)
		dc = new Action("moveTo", new Numeral(2), new Numeral(3));
		...
		dc = new Percept("sensors", new ParameterList(new Function("red", new Identifier("ball")),
		...
		dc = new Percept("entities", new ParameterList());

		System.out.println(dc.toProlog() + "\n");
		System.out.println(dc.toXML());
		System.out.println("");
		/*
		 * // kills the environment dc = new EnvironmentCommand(
		 * EnvironmentCommand.PAUSE );
		 * 
		 * System.out.println(dc.toProlog() + "\n");
		 * System.out.println(dc.toXML()); System.out.println("");
		 * 
		 * // init dc = new EnvironmentCommand( EnvironmentCommand.INIT, new
		 * Identifier("/home/groucho/eisexamples/config.txt") );
		 * 
		 * System.out.println(dc.toProlog() + "\n");
		 * System.out.println(dc.toXML()); System.out.println("");
		 * 
		 * // request time dc = new EnvironmentCommand( "request", new
		 * Identifier("time") );
		 * 
		 * System.out.println(dc.toProlog() + "\n");
		 * System.out.println(dc.toXML()); System.out.println("");
		 * 
		 * // execution has stopped dc = new EnvironmentEvent(
		 ...
		 * 
		 * // execution has stopped dc = new EnvironmentEvent(
		 * "environmentTime", new Numeral(System.currentTimeMillis()) );
		 * 
		 * System.out.println(dc.toProlog() + "\n");
		 * System.out.println(dc.toXML()); System.out.println("");
		 */
