...
public interface EnvironmentListener {
	 ...
	 * Handles a new state.
	 *
	 * @param newState the new environment state
	 */
	void handleStateChange(EnvironmentState newState);

	/**
	 * Handles the event that an entity has been freed. This assumes that the entity
	 * was already there and thus that the environment was ready to handle
