...
public interface AllPerceptsProvider {
	/**
	 * A batch of percepts should be returned as a map of the methods annotated with
	 * {@link AsPercept} and the results of their invocation.
	 *
	 * Note that when {@link AsPercept#event()} is true for a percept, the
	 * implementation must store all results from that percept until this method is
	 * called.
	 *
